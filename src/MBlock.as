...
//			openSwf("orion_buzzer.swf");
		...
		public function serialDisconnect():void{
		...
		private function setProjectName(s:String):void {
			if (s.slice(-3) == '.cl') s = s.slice(0, -3);
			if (s.slice(-4) == '.cl2') s = s.slice(0, -4);
...
//				var zipData:ByteArray = projIO.encodeProjectAsZipFile(stagePane);
				...
				if(projectFile != null){
					...
					var defaultName:String = (projectName().length > 1) ? projectName() + '.cl2' : 'project.cl2';
