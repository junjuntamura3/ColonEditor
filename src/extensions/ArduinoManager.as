package extensions
{
	...
	public class ArduinoManager extends EventDispatcher
	{
		...
		*/
		...
		private var codeTemplate:String = ( <![CDATA[#include <LedControl.h>
#include <Servo.h>
#include <Wire.h>
#include <Arduino.h>
#include <Colon.h>
...
// jun-ichi TAMURA 2017-02-10
			//			SerialManager.sharedManager().upgrade(projectPath+"/build/"+projectDocumentName+".ino.hex");
			SerialManager.sharedManager().upgrade2(projectPath+"/build/"+projectDocumentName+".ino.hex");
		...
		public function buildAll(ccode:String):String
		{
			...
			// jun-ichi TAMURA 2017-02-10
			SerialManager.sharedManager().executeUpgrade2();
			/*
...
//				file = new File(arduinoInstallPath+"/arduino.exe"); // 2018-10-31 jun-ichi TAMURA original
//				file = new File("C:/Program\ Files\ (x86)/Arduino/arduino.exe"); // 2018-10-31 jun-ichi TAMURA debug
				//				file = new File("C:/Program\ Files/Arduino/arduino.exe");
				var baseFile:File = File.applicationDirectory;
				file = new File(baseFile.nativePath+"/../Arduino/arduino.exe");
			}else{
...
//				}
		...
		private function buildArduinoLib(buildDir:File):void{
			...
			if(_currentDevice=="uno" || _currentDevice=="leonardo"){
				...
				listArduinoLib(new File(arduinoInstallPath+"/libraries/Colon"));
				listArduinoLib(new File(arduinoInstallPath+"/libraries/LedControl"));
				listArduinoLib(new File(arduinoInstallPath+"/libraries/Adafruit_NeoPixel"));
			}
...
//			trace("currentDevice:",_currentDevice);
			if(_currentDevice=="uno"){
				...
				cmd = " -c -g -Os -w -fno-exceptions -ffunction-sections -fdata-sections -MMD -mmcu=atmega1280 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_MEGA -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/mega -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="mega2560"){
				cmd = " -c -g -Os -w -fno-exceptions -ffunction-sections -fdata-sections -MMD -mmcu=atmega2560 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_MEGA2560 -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/mega -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="nano328"){
				cmd = " -c -g -Os -w -fno-exceptions -ffunction-sections -fdata-sections -MMD -mmcu=atmega328p -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_NANO -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/eightanaloginputs -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="nano168"){
				cmd = " -c -g -Os -w -fno-exceptions -ffunction-sections -fdata-sections -MMD -mmcu=atmega168 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_NANO -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/eightanaloginputs -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}
		...
		private function compileC(cpp:String, dir:File):void{
			...
			if(_currentDevice=="uno"){
				...
				cmd = " -c -g -Os -w -ffunction-sections -fdata-sections -MMD -mmcu=atmega1280 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_MEGA -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/mega -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="mega2560"){
				cmd = " -c -g -Os -w -ffunction-sections -fdata-sections -MMD -mmcu=atmega2560 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_MEGA2560 -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/mega -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="nano328"){
				cmd = " -c -g -Os -w -ffunction-sections -fdata-sections -MMD -mmcu=atmega328p -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_NANO -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/eightanaloginputs -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}else if(_currentDevice=="nano168"){
				cmd = " -c -g -Os -w -ffunction-sections -fdata-sections -MMD -mmcu=atmega168 -DF_CPU=16000000L -DARDUINO=10605 -DARDUINO_AVR_NANO -DARDUINO_ARCH_AVR -I"+path+avrPath+"/cores/arduino -I"+path+avrPath+"/variants/eightanaloginputs -I"+path+"/libraries/Servo/src -I"+path+"/libraries/Servo -I"+path+arduinoLibPath+"/Wire -I"+path+arduinoLibPath+"/Wire/utility -I"+path+arduinoLibPath+"/SoftwareSerial -I"+path+"/libraries/Colon/src -I"+path+"/libraries/LedControl/src -I"+path+"/libraries/Adafruit_NeoPixel"
			}
...
MBlock.app.scriptsPart.appendMessage("DBUG:onExit(ArduinoManager)"); // jun-ichi TAMURA 2017-03-22
