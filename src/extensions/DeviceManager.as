package extensions
{
	...
	public class DeviceManager
	{
		...
		{
// jun-ichi TAMURA 2016-12-26
//			onSelectBoard(SharedObjectManager.sharedManager().getObject("board","mbot_uno"));
			onSelectBoard(SharedObjectManager.sharedManager().getObject("board","arduino_leonardo"));
		}
...
//					MBlock.app.extensionManager.singleSelectExtension("Arduino");
					MBlock.app.extensionManager.singleSelectExtension("Colon");
